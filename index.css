              ...
              {members.slice(0, 10).map(m => (
                <tr key={m.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <button className="text-accent hover:text-accent-dark font-bold text-xs uppercase tracking-widest">View Details</button>
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="card space-y-4">
          <h3 className="font-bold border-b border-border pb-2">Issue New Loan</h3>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select className="input">
                  <option>1 Year (10%)</option>
                  <option>2 Years (20%)</option>
                </select>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded-xl space-y-2 border border-border">
              <div className="flex justify-between text-xs">
                <span className="text-muted">Interest (10%)</span>
        ...
        <div className="card h-full flex flex-col justify-center items-center text-center p-12">
          ...
          <h4 className="font-bold mb-2">Loan Eligibility Check</h4>
          <p className="text-muted text-sm max-w-[240px]">Select a member to see their current savings and maximum eligibility.</p>
        </div>
      </div>

      <div className="card p-0 overflow-hidden">
        <h3 className="p-6 font-bold border-b border-border">Active Loans</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-slate-50 border-b border-border">
              <tr>
                ...
                <th className="px-6 py-4 text-xs font-bold text-muted uppercase">Balance</th>
                <th className="px-6 py-4 text-xs font-bold text-muted uppercase">Progress</th>
                <th className="px-6 py-4 text-xs font-bold text-muted uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {/* This would be populated from getLoans API */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <BentoKPICard label="Active Loan Balance" value="KSh 45,000" trend="Next due in 4 days" trendColor="text-blue-500" />
            </div>
          ...
          <div className="space-y-6">
            <div className="card bg-primary text-white border-2 border-slate-800 relative overflow-hidden">
              <div className="absolute -top-4 -right-4 p-4 opacity-10 rotate-12">
                <HandCoins size={120} />
              </div>
              <div className="relative z-10">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-accent mb-4">Loan Eligibility</h3>
                <p className="text-3xl font-bold mb-2">KSh 120,400</p>
                <p className="text-slate-400 text-xs mb-6 max-w-[180px]">Available limit based on your total savings capacity.</p>
                <button className="btn w-full bg-white text-primary hover:bg-slate-100 font-bold">
                  Instant Application
                </button>
              </div>
            </div>
            ...
            <div className="card space-y-6">
              ...
              <div className="space-y-4">
                ...
                <ObligationItem icon={<HandCoins size={16} />} label="Loan Repayment" date="May 15" amount="KSh 2,500" />
              </div>
